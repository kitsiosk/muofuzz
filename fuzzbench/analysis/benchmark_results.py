...
class BenchmarkResults:
    ...
    @property
    @functools.lru_cache()
    def mann_whitney_p_values_onesided(self):
        """Mann Whitney U test result."""
        return stat_tests.one_sided_u_test(self._benchmark_snapshot_df,
                                           key='edges_covered')
    ...
    def wilcoxon_test(self):
        """Mann Whitney U test result."""
        return stat_tests.one_sided_wilcoxon_test(self._benchmark_snapshot_df,
                                           key='edges_covered')
