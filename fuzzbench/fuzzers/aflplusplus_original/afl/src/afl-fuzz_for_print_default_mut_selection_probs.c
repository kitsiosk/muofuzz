...
//       }
//       //printf("Stage %u: %llu finds in %llu cycles\n", i, afl->stage_finds[i], afl->stage_cycles[i]);
//   }
...
// const int MUT_STRATEGY_ARRAY_SIZE = 256;
...
// };
//   int a1[MUT_MAX], a2[MUT_MAX], a3[MUT_MAX], a4[MUT_MAX], a5[MUT_MAX], a6[MUT_MAX], a7[MUT_MAX], a8[MUT_MAX];;
//   for (int j=0; j<MUT_MAX; ++j){
//     a1[j] = 0;
//     a2[j] = 0;
//     a3[j] = 0;
//     a4[j] = 0;
...
//     a8[j] = 0;
//   }
//   for (int i = 0; i<MUT_TXT_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == text_array[i]) a1[j]++;
//     }
//   }

//   for (int i = 0; i<MUT_BIN_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == binary_array[i]) a2[j]++;
//     }
//   }

//   for (int i = 0; i<MUT_NORMAL_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == normal_splice_array[i]) a3[j]++;
//     }
//   }

//   for (int i = 0; i<MUT_SPLICE_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == full_splice_array[i]) a4[j]++;
//     }
//   }
  
//   for (int i = 0; i<MUT_STRATEGY_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == mutation_strategy_exploration_text[i]) a5[j]++;
//     }
//   }

//   for (int i = 0; i<MUT_STRATEGY_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == mutation_strategy_exploration_binary[i]) a6[j]++;
//     }
//   }

//   for (int i = 0; i<MUT_STRATEGY_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == mutation_strategy_exploitation_text[i]) a7[j]++;
//     }
//   }

//   for (int i = 0; i<MUT_STRATEGY_ARRAY_SIZE; ++i){
//     for (int j=0; j<MUT_MAX; ++j){
//       if (j == mutation_strategy_exploitation_binary[i]) a8[j]++;
//     }
//   }

//   print_array(a1, MUT_MAX);
//   print_array(a2, MUT_MAX);
//   print_array(a3, MUT_MAX);
//   print_array(a4, MUT_MAX);
//   print_array(a5, MUT_MAX);
//   print_array(a6, MUT_MAX);
//   print_array(a7, MUT_MAX);
//   print_array(a8, MUT_MAX);
...
//           // u32 *finds_per_mutator = (u32 *)malloc(rand_max * sizeof(u32));
//           // for (i=0; i<rand_max; ++i){ // all mutators start with 0 finds
//           //   finds_per_mutator[i] = 0;
//           // }
...
//       queue_cnt++;
//       if ((queue_cnt % 3000 == 0) || (queue_cnt == 10)) {
