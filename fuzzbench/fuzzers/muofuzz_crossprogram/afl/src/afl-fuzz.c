...
int main(int argc, char **argv_orig, char **envp) {
  ...
  // The 32x32 array below was derived from the freetype program.
  // Here, we test if it can be used to generate effective mutator sequences
  // in other programs as well.
  u32 finds_per_mutator_from_freetype[32][32] = {
    { 3, 3, 3, 3, 4, 4, 3, 3, 4, 3, 3, 3, 3, 3, 4, 4, 3, 3, 2, 3, 10, 4, 5, 5, 5, 4, 8, 5, 5, 10, 5, 13 },
    { 3, 3, 2, 3, 4, 3, 2, 3, 2, 2, 3, 4, 2, 3, 3, 4, 3, 3, 1, 2, 9, 4, 6, 4, 4, 3, 6, 6, 5, 10, 6, 14 },
    { 2, 3, 3, 3, 3, 3, 2, 4, 3, 3, 3, 4, 3, 2, 4, 5, 4, 2, 2, 2, 10, 5, 4, 4, 5, 4, 8, 6, 7, 12, 9, 15 },
    { 4, 3, 4, 4, 4, 5, 2, 4, 2, 3, 4, 3, 4, 4, 3, 3, 3, 2, 3, 3, 10, 4, 6, 4, 5, 3, 8, 6, 6, 11, 7, 14 },
    { 3, 4, 4, 5, 5, 5, 4, 5, 3, 4, 4, 4, 3, 5, 5, 4, 3, 3, 3, 3, 11, 6, 7, 4, 5, 5, 10, 7, 6, 9, 7, 14 },
    { 4, 3, 4, 4, 4, 4, 4, 3, 3, 3, 5, 6, 3, 5, 5, 4, 4, 4, 3, 4, 14, 5, 6, 4, 4, 4, 8, 7, 5, 11, 5, 15 },
    { 2, 3, 2, 3, 4, 4, 2, 3, 2, 3, 3, 2, 3, 3, 3, 3, 3, 2, 2, 2, 10, 5, 5, 4, 5, 4, 6, 6, 5, 13, 6, 16 },
    { 3, 3, 5, 4, 4, 4, 3, 3, 4, 3, 5, 4, 4, 3, 4, 5, 4, 4, 3, 3, 11, 4, 4, 5, 5, 4, 9, 6, 6, 12, 7, 16 },
    { 3, 3, 3, 3, 3, 3, 3, 3, 3, 4, 2, 3, 3, 3, 4, 3, 2, 2, 3, 2, 11, 4, 5, 4, 4, 4, 6, 6, 4, 11, 6, 14 },
    { 3, 3, 3, 3, 3, 4, 3, 4, 2, 2, 5, 2, 3, 2, 4, 3, 3, 3, 2, 2, 11, 4, 5, 6, 5, 4, 8, 7, 6, 10, 7, 13 },
    { 3, 3, 3, 3, 4, 4, 3, 5, 4, 3, 5, 5, 3, 3, 4, 4, 4, 4, 3, 3, 9, 4, 7, 3, 5, 4, 9, 6, 6, 10, 7, 15 },
    { 4, 4, 4, 2, 4, 4, 3, 4, 4, 4, 4, 4, 3, 4, 5, 4, 4, 3, 3, 2, 11, 5, 6, 4, 5, 4, 7, 7, 6, 11, 7, 16 },
    { 4, 3, 4, 5, 5, 4, 5, 3, 4, 3, 4, 4, 3, 3, 5, 5, 6, 4, 3, 3, 7, 4, 6, 3, 4, 4, 7, 5, 5, 9, 6, 12 },
    { 8, 8, 7, 8, 9, 8, 7, 10, 7, 7, 9, 8, 9, 8, 8, 9, 7, 8, 6, 7, 13, 6, 8, 6, 9, 7, 12, 8, 6, 13, 10, 17 },
    { 5, 6, 6, 6, 7, 7, 6, 5, 5, 4, 6, 5, 5, 6, 6, 5, 6, 6, 5, 5, 9, 5, 7, 5, 5, 5, 7, 6, 4, 9, 7, 12 },
    { 5, 5, 6, 6, 6, 7, 6, 5, 5, 6, 6, 6, 7, 6, 4, 5, 7, 5, 6, 6, 8, 5, 7, 4, 4, 5, 8, 6, 5, 10, 10, 13 },
    { 11, 12, 11, 10, 11, 11, 10, 10, 11, 8, 9, 11, 11, 11, 12, 11, 11, 11, 10, 11, 13, 8, 11, 7, 10, 8, 11, 9, 7, 11, 12, 16 },
    { 7, 7, 8, 7, 7, 8, 7, 6, 6, 7, 9, 9, 7, 7, 8, 7, 8, 7, 7, 6, 13, 7, 10, 6, 7, 6, 12, 7, 8, 11, 11, 16 },
    { 14, 14, 15, 17, 15, 16, 13, 15, 13, 12, 14, 15, 15, 13, 16, 17, 13, 13, 13, 14, 20, 9, 16, 11, 17, 10, 18, 10, 10, 16, 19, 25 },
  };
  printf("0\n");
  ...
  // Copy values from finds_per_mutator_from_freetype to finds_per_mutator
  for (u32 i = 0; i < mut_max; i++) {
      for (u32 j = 0; j < mut_max; j++) {
          afl->finds_per_mutator[i][j] = finds_per_mutator_from_freetype[i][j];
      }
  }
  ...
  afl->start_time = get_cur_time();
  double training_hours = 0; //no training time here, we jump into the guided mutation phase directly
  ...
  while (likely(!afl->stop_soon)) {
    ...
    cull_queue(afl);
    // if all the seeds in the queue were ran in this cycle
    ...
    } // end - if all the seeds in the queue were executed in this cycle
    ...
    do {
      ...
      if (likely(!afl->old_seed_selection)) {
        ...
        if (likely(afl->pending_favored && afl->smallest_favored >= 0)) {
          // if there is a favored test case that is pending, selecet it as next
          ...
          */
          ...
          // if there is no favored test case that is pending
          // (all favored have been executed at least once)
          if (unlikely(prev_queued_items < afl->queued_items ||
                       afl->reinit_table)) {

            // we have new queue entries since the last run, recreate alias
            // table
            // 1. q->weight = compute_weights(), based on n_fuzzed, exec time, bitmap size etc
            // 2. q->perf_score = calculate_score(), based on exec time, bitmap size 
            //                     (slower seeds fuzzed less ofter, don't we already do it above?
            // 3. populate afl->alias_probability and afl->alias_table
      ...
      // After 2 hours we set the epsilon to 0.5 from 1.0 to enable exploitation
